...
<ta:box cols="3" id="box1">
    <ta:date id="startDate" key="开始时间" showSelectPanel="true" bpopTipPosition="bottom"></ta:date>
    <ta:date id="endDate" key="结束时间" showSelectPanel="true" bpopTipPosition="bottom"></ta:date>
...
<ta:panel key="功能访问日志" fit="true" hasBorder="false" titleAlign="left">
    <ta:datagrid id="accessGrid"  fit="true" haveSn="true"  columnFilter="true" forceFitColumns="true" >
        ...
        <ta:datagridItem key="时间" id="accesstime" sortable="true" width="150" dataType="dateTime"/>
        <ta:datagridItem key="系统" id="sysflag"/>
        <ta:dataGridToolPaging url="accessLogController!queryAccess.do" pageSize="1000" submitIds="box1" selectExpButtons="1,2"></ta:dataGridToolPaging>
    </ta:datagrid>
</ta:panel>
</body>
</html>
<script type="text/javascript">
    ...
    function fnQuery(){
        Base.submit("box1,accessGrid","accessLogController!queryAccess.do");
    }
</script>
