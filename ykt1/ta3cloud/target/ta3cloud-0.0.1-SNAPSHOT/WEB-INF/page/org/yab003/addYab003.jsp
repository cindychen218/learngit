...
<ta:panel id="addPanel" fit="true" withButtonBar="true" hasBorder="false" bodyStyle="padding:10px 10px 0px 0px;">
	...
	<ta:text id="t_codeType"  key="代码类别" value="YAB003" readOnly="true" required="true" labelWidth="120" bpopTipPosition="bottom"/>
	<ta:text id="t_codeTypeDESC"  key="类别名称" value="经办机构" readOnly="true" required="true" labelWidth="120"/>
	<ta:text id="t_codeValue"  key="代码值"   required="true" validType='[{type:"maxLength",param:[20],msg:"最大长度为20"}]' labelWidth="120"/>
	<ta:text id="t_codeDESC"  key="经办机构名称"  required="true" validType='[{type:"maxLength",param:[50],msg:"最大长度为50"}]' labelWidth="120"/>
	...
	<ta:panelButtonBar align="right">
		<ta:button id="confirmAdd" key="确认" onClick="confirmAdd()"></ta:button>
...
<script type="text/javascript">
    ...
    function confirmAdd(treeId, treeNode){
        Base.submit("addPanel","agenciesMgAction!addOrEditTreeNode.do",{"dto['yab003']":Base.getValue("treeNodeId"),"dto['insertApp']":"1"},null,null,function(){
            ...
            var t_codeValue = Base.getValue("t_codeValue");
            var childNode = {name:nodeValue,id:t_codeValue};
