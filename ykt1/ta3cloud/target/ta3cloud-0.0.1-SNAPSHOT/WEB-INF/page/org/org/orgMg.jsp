...
<body class="no-scrollbar no-padding" layout="border" layoutCfg="{leftWidth:340}">
<ta:pageloading/>
<ta:box position="left" key="组织">
    ...
    <%--</div>--%>
    <ta:text id="searchbox" clickIcon="icon-search" placeholder="搜索" clickIconFn="fnQuery()"></ta:text>
...
<ta:box position="center">
    <ta:form id="orgForm" fit="true">
        <ta:box id="departPanel" position="center"  cssStyle="padding:30px 10px 0px 10px;"  cols="2"  fit="true">
            ...
            <ta:text id="porgname" key="父级组织" readOnly="true" columnWidth="0.6" span="2" labelWidth="125"  bpopTipPosition="bottom"/>
            <ta:text id="orgnamepath" key="组织路径" readOnly="true" columnWidth="0.6" span="2" disabled="true" labelWidth="125" bpopTipPosition="bottom"/>
            <ta:text id="orgname" key="组织名称"  validType='[{type:"maxLength",param:[60],msg:"最大长度为60"}]'  required="true" columnWidth="0.6" span="2"  labelWidth="125"/>
            <ta:box span="2" columnWidth="0.6" cols="2">
                <ta:text id="costomno" key="自定义编码" columnWidth="0.5" validType='[{type:"maxLength",param:[20],msg:"最大长度为20"},{type:"compare",param:[">","maxUdi"]}]' labelWidth="125"/>
                <ta:text id="maxUdi" key="已使用最大编号" columnWidth="0.5" readOnly="true"  validType='[{type:"maxLength",param:[20],msg:"最大长度为20"}]' labelWidth="110" />
            </ta:box>
            ...
            <ta:text id="orgmanager_name" key="组织负责人(正职)" columnWidth="0.6" span="2" labelWidth="125" readOnly="true" popWinBeforeClick="fnPopWinBeforeClick" popWin="true" popWinUrl="orgMgAction!webSelectOrgManager.do" popWinWidth="80%" popWinHeight="80%" popParam="{'managerType':'1'}" popSubmitIds="orgmanager,orgmanager_deputy"/>
            <ta:text id="orgmanager_deputy" display="false"/>
            <ta:text id="orgmanager_deputy_name" key="组织负责人(副职)" columnWidth="0.6" span="2" labelWidth="125" readOnly="true" popWinBeforeClick="fnPopWinBeforeClick" popWin="true" popWinUrl="orgMgAction!webSelectOrgManager.do" popWinWidth="80%" popWinHeight="80%" popParam="{'managerType':'2'}" popSubmitIds="orgmanager,orgmanager_deputy"/>
            <ta:selectInput id="yab003" collection="yab003" key="经办机构" required="true" span="2" labelWidth="125" columnWidth="0.6" filterOrg="false"  onSelect="fnYab139Filter"/>
            <ta:selectInput id="yab139"  key="数据区"  span="2" labelWidth="125" columnWidth="0.6"  displayValue="codeDESC"  hiddenValue="codeValue"  required="true" />
            ...
            <ta:buttonGroup>
                <ta:button type="submit"  url="orgMgAction!webUpdateOrg.do" id="update"  key="保存[S]" onSubmit="fnBeforeUpdateOrg" submitIds="departPanel" hotKey="S" icon="icon-addTo" successCallBack="fnRefleshTree" disabled="true"/>
                <ta:button  url="orgMgAction!webSaveOrg.do" id="save" key="保存[S]" onSubmit="fnBeforeSaveOrg" submitIds="orgForm" hotKey="S" icon="icon-addTo" successCallBack="fnSaveSuccessCb" display="false" disabled="true"/>
            </ta:buttonGroup>
        </ta:box>
    </ta:form>
</ta:box>
