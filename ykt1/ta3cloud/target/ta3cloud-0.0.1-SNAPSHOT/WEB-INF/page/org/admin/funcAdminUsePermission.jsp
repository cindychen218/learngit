...
<ta:panel id="addpanel" fit="true" cols="1" bodyStyle="overflow:auto;" withButtonBar="true" hasBorder="false">
	...
	<ta:panelButtonBar align="right">
		<ta:button id="saveBtn" key="保存[S]" hotKey="S"  icon="icon-addTo" onClick="fnSaveOp('adminUserMgAction!saveAdminUsePermission.do')"/>
		<ta:button id="closeOpBtn" key="关闭[X]" hotKey="X" icon="icon-close2" onClick="parent.Base.closeWindow('adminUseWin');"/>
	</ta:panelButtonBar>
</ta:panel>
</body>
</html>
