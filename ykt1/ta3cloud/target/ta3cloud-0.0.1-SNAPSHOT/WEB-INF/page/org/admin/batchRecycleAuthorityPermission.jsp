...
<ta:panel id="panel1" hasBorder="false" expanded="false" fit="true" bodyStyle="margin:0px 10px;"  withButtonBar="true">
	<ta:box fit="true" cols="2">
		<ta:panel  key="授权权限" hasBorder="true" expanded="false" fit="true">
		...
		<ta:panel  key="再授权权限" hasBorder="true" expanded="false" cssStyle="margin-left:10px;" fit="true">
	...
	<ta:panelButtonBar align="right">
		<ta:button id="saveRoleGrantingBtn" key="保存[S]" hotKey="S" icon="icon-addTo" onClick="fnSaveGranting('adminUserMgAction!recycleAuthorityPermissions.do')"/>
		<ta:button id="closeGrantingBtn" key="关闭[X]" hotKey="X" icon="icon-close2" onClick="parent.Base.closeWindow('grantingWin');"/>
	</ta:panelButtonBar>
</ta:panel>
</body>
</html>
<script>
    ...
    function fnSaveGranting(url) {
		...
		var positionids = Base.getValue("recycleAuthorityPermissionsPositionids").split(",");
		var positionDto = "";
		...
		if (str != "") {
            ...
            Base.submit("panel1", url, {"ids":str,"positionids":positionDto},null,null,function(){
