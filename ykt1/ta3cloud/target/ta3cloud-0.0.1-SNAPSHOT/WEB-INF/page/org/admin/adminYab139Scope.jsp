...
<ta:panel id="panel1" hasBorder="false" expanded="false" fit="true" withButtonBar="true">
	...
	<ta:panelButtonBar align="right">
		<ta:button id="btnSave" key="保存[S]" hotKey="S" icon="icon-addTo" onClick="fnSaveAdminYab003Scope()"></ta:button>
		<ta:button id="btnClose" key="关闭[X]" hotKey="X" icon="icon-close2" onClick="parent.Base.closeWindow('adminYab003Win')"></ta:button>
	</ta:panelButtonBar>
</ta:panel>
</body>
</html>
