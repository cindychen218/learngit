...
<ta:panel id="panel1" hasBorder="false" expanded="false" fit="true" bodyStyle="overflow:auto;" withButtonBar="true">
	...
	<ta:panelButtonBar align="right">
		<ta:button id="saveScopeOpBtn" key="保存[S]" hotKey="s" icon="icon-addTo" onClick="fnSaveOp('adminUserMgAction!saveOrgMgScope.do')"/>
		<ta:button id="closeOpBtn" key="关闭[X]" hotKey="x" icon="icon-close2" onClick="parent.Base.closeWindow('mgScope');"/>
	</ta:panelButtonBar>
</ta:panel>
</body>
</html>
