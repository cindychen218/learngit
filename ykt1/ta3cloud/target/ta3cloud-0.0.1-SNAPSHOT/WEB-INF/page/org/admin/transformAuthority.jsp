...
<ta:panel fit="true" hasBorder="false" withButtonBar="true">
	<ta:datagrid fit="true" id="userGrid" haveSn="true" selectType="radio">
		...
		<ta:datagridItem id="orgnamepath" key="所属路径" width="280"></ta:datagridItem>
	</ta:datagrid>
	<ta:panelButtonBar align="right">
		<ta:button key="保存[S]" onClick="fnSave()" icon="icon-addTo" hotKey="s"/>
		<ta:button key="关闭[X]" icon="icon-close2" onClick="parent.Base.closeWindow('transformWin')" hotKey="x"/>
	</ta:panelButtonBar>
</ta:panel>
</body>
</html>
