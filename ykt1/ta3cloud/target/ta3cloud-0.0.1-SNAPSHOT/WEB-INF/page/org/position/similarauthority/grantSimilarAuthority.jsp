...
<ta:box fit="true" cssStyle="padding: 0px;">
	<ta:fieldset>
		<div style="color:red;">你在表格中所勾选的岗位将“获取”这些被勾选的资源的使用权限.</div>
	</ta:fieldset>
	<ta:panel id="panel1" hasBorder="true" expanded="false" fit="true" bodyStyle="overflow:auto; margin: 0 10px" withButtonBar="true" bodyClass="linecolor" cssStyle="margin-top:10px;">
		...
		<ta:panelButtonBar align="right">
			<ta:button id="recyclePermissionsOpBtn" key="保存" icon="icon-addTo" onClick="fnRecyclePermissionsOp('similarAuthorityAction!saveSimilarAuthority.do')"/>
			<ta:button id="closeOpBtn" key="关闭" icon="icon-close2"  onClick="Base.closeWindow('similar');" />
		</ta:panelButtonBar>
	</ta:panel>
</ta:box>
<script>
