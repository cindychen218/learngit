...
<ta:panel id="grantpanel" hasBorder="true" fit="true" cols="1" bodyClass="linecolor" withButtonBar="true">
	...
	<ta:panelButtonBar align="right">
		<ta:button id="personalrecyclePermissionsOpBtn" key="保存[S]" hotKey="s" icon="icon-addTo" onClick="fnRecyclePermissionsOp('positionUserMgAction!grantUsePermissions.do')"/>
		<ta:button id="recyclePermissionsOpBtn" key="保存[S]" hotKey="s" icon="icon-addTo"  onClick="fnRecyclePermissionsOp('positionUserMgAction!grantUsePermissions.do')"/>
