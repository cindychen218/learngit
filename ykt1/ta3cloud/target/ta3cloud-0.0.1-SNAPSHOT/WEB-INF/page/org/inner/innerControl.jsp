...
<ta:box fit="true">
	<ta:fieldset key="过滤条件" id="field1"  cols="5">
		...
		<ta:buttonGroup span="5" id="btn1" cssStyle="display:none;">
			<ta:button key="查询" onClick="fnQuery()"></ta:button>
		</ta:buttonGroup>
	</ta:fieldset>
	<ta:tabs fit="true" hasBorder="false" headPlain="false" >
		<ta:tab key="业务人员" id="adminTab">
			<ta:datagrid fit="true" haveSn="true" id="grid1" columnFilter="true" forceFitColumns="true">
		...
		<ta:tab key="某岗被某人授予" id="businessTab">
			<ta:datagrid fit="true" haveSn="true" id="grid2" columnFilter="true" forceFitColumns="true">
		...
		<ta:tab key="该功能被谁授予给某岗位" id="menuTab">
			<ta:datagrid fit="true" haveSn="true" id="grid3" columnFilter="true" forceFitColumns="true">
				<ta:datagridItem id="usernamepath" key="授权管理员" width="400" showDetailed="true"/>
				<ta:datagridItem id="orgnamepath" key="被授权岗位" width="400" showDetailed="true"/>
				<ta:datagridItem id="optime" key="操作时间" width="150"/>
			</ta:datagrid>
    ...
    function fnSelect(value,key){
        ...
        switch(key){
            case "0":
                ...
                Base.hideObj("businessPop,menuTree");
            ...
            case "1":
                ...
                Base.hideObj("adminPop,menuTree,positionPop");
