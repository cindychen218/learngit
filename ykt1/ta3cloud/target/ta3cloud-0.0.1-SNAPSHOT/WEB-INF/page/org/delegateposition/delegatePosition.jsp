...
<ta:buttonGroup align="left">
	<ta:button key="新增委派人员" icon="icon-addTo" onClick="fnAdd()"></ta:button>
	<ta:button key="批量删除" icon="icon-close2" onClick="fnRemove()" disabled="true"  id="btnRemove"></ta:button>
</ta:buttonGroup>
<ta:panel fit="true" key="委派岗位列表" cssStyle="margin-top:10px;">
	<ta:datagrid fit="true" selectType="checkbox" haveSn="true" id="deletegatedGrid" onSelectChange="fnSelectChange">
		...
		<ta:datagridItem id="permissionInfo" key="查看/修改权限" width="100" icon="icon-search" click="fnPermissionInfo"></ta:datagridItem>
...
<script type="text/javascript">
    ...
    function fnPermissionInfo(data,e){
        Base.openWindow("permissionInfo",data.positionname +"的代理权限","delegatePositionAction!queryPermissionInfoByPositionid.do",{"positionid":data.positionid,"validtime":data.validtime},500,500,function(){
