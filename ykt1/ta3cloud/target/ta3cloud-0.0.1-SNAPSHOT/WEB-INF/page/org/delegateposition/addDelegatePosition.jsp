...
<ta:box layout="border" layoutCfg="{leftWidth:250}">
	...
	<ta:box position="center" cssStyle="padding:10px 10px 0px 10px;">
		<ta:box>
			<ta:date id="deletegateTime" key="委派截止时间" showSelectPanel="true" labelWidth="120"
					 validNowTime="right" required="true" datetime="true" bpopTipPosition="bottom"></ta:date>
		</ta:box>
		<ta:panel fit="true" key="可委派人员" cssStyle="margin-top:10px;"
			...
			<ta:panelButtonBar align="right">
				<ta:button key="保存" icon="icon-addTo"
						   onClick="fnSaveDeletegatePosition()"></ta:button>
				<ta:button key="关闭" icon="icon-close2" onClick="fnClose()"></ta:button>
			</ta:panelButtonBar>
		</ta:panel>
	</ta:box>
</ta:box>
