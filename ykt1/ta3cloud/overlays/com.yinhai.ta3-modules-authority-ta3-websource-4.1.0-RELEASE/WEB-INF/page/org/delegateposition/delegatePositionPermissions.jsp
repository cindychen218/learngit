...
<ta:panel fit="true"  withButtonBar="true" cols="2" hasBorder="false">
    <ta:box span="2">
        <ta:date id="validtime" validNowTime="right" datetime="true" showSelectPanel="true" required="true" key="委派截止时间" labelWidth="120" bpopTipPosition="bottom"></ta:date>
    </ta:box>
    ...
    <ta:panelButtonBar align="right">
        <ta:button key="保存" icon="icon-addTo" onClick="fnSavePermissions()"></ta:button>
