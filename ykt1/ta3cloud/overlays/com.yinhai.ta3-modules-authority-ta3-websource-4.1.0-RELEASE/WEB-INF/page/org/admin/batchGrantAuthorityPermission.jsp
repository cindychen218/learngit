...
<ta:panel id="gpanel" hasBorder="false" expanded="false" fit="true"  bodyStyle="margin:0px 10px;" withButtonBar="true">
    ...
    <ta:panelButtonBar align="right">
        <ta:button id="saveRoleGrantingBtn" key="保存[S]" hotKey="S" icon="icon-addTo" onClick="fnSaveGranting('adminUserMgAction!grantAuthorityPermissions.do')"/>
...
<script>
    ...
    function fnSaveGranting(url) {
		...
		var positionids = Base.getValue("grantAuthorityPermissionsPositionids").split(",");
		var positionDto = "";
        ...
        if (str != "") {
            ...
            Base.submit("gpanel", url, {"ids":str,"positionids":positionDto},null,null,function(){
