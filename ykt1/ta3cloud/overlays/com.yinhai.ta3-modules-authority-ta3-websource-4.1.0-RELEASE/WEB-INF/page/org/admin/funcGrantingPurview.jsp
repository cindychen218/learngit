...
<ta:panel id="panel1" hasBorder="false" expanded="false" fit="true" withButtonBar="true" bodyStyle="overflow:auto;margin:0px 10px" layout="column">
	<ta:box fit="true" cols="2">
		<ta:text id="grantPositionid" display="false"/>
		<ta:text id="positionType" display="false"/>
		<ta:panel id="panel" key="授权权限" hasBorder="true" expanded="false" fit="true">
		...
		<ta:panel id="panel2" key="再授权权限" hasBorder="true" expanded="false" cssStyle="margin-left:10px;" fit="true">
	...
	<ta:panelButtonBar align="right">
		<ta:button id="saveRoleGrantingBtn" key="保存[S]" hotKey="S" icon="icon-addTo" onClick="fnSaveGranting('adminUserMgAction!saveRoleScopeAclGranting.do')"/>
