...
<body id="body1" class="no-scrollbar" style="margin:0px;padding:10px 10px 0 10px;">
<ta:pageloading/>
...
<ta:box height="100%" cols="2">
	<ta:box height="100%" columnWidth="0.3">
		<ta:panel fit="true" key="第一步：选择同时拥有某几个功能权限的岗位(或人员)" titleAlign="left" withButtonBar="true" >
			...
			<ta:panelButtonBar>
				<ta:button id="btnQuery" key="查找" onClick="fnQuery()"  icon="icon-search"></ta:button>
			</ta:panelButtonBar>
		</ta:panel>
	</ta:box>
	<ta:box height="100%" columnWidth="0.7" cssStyle="margin-left:10px;">
		<ta:panel fit="true" key="第二步：选择需要授权的岗位(或人员)" titleAlign="left" withButtonBar="true">
			...
			<ta:panelButtonBar>
				<ta:button id="btnEdit" key="授权"  onClick="fnToSimilarAuthority()" icon="icon-addTo"></ta:button>
			</ta:panelButtonBar>
		</ta:panel>
	</ta:box>
</ta:box>
