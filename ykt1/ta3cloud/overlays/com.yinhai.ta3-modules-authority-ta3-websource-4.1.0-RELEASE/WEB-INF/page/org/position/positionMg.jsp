...
<ta:pageloading/>
<ta:tabs fit="true" id="" hasBorder="false">
	<ta:tab id="tabPos" key="岗位权限" layout="border" layoutCfg="{leftWidth:410}" selected="true">
		<ta:box position="left" cssStyle="padding:10px" key="岗位维护" >
			<ta:fieldset id="queryPos"  cols="2">
				<ta:selectTree columnWidth="0.75"  url="positionUserMgAction!webQueryAsyncOrgPubTree.do"  labelWidth="65"   fontCss="fnFontCss" selectTreeBeforeClick="fnBeforeClick"  idKey="orgid" parentKey="porgid" nameKey="orgname" asyncParam="['orgid']"
				...
				<ta:text id="positionname" key="岗位"  placeholder="请输入岗位名称..." columnWidth="0.75" labelWidth="65" />
				<ta:buttonGroup columnWidth="0.25" align="left">
					<ta:button key="查找" onClick="fnQueryPos();"></ta:button>
				</ta:buttonGroup>
			</ta:fieldset>
			<ta:buttonGroup align="left" cssStyle="margin-top:10px;margin-left:0px;">
				<ta:button key="新增" toolTip="新增岗位" onClick="fnAddPosition()"></ta:button>
				...
				<ta:selectButton key="禁用/启用" id="usePos" cssStyle="margin-left: 10px">
				...
				<ta:selectButton key="批量权限操作" id="datchPer" cssStyle="margin-top: 10px">
		...
		<ta:box position="center" cssStyle="padding:10px;">
			<ta:box id="posMissionBox" fit="true" cssStyle="overflow:auto;margin-left:0px;">
				<ta:box height="8%">
				...
				<ta:box height="50%" cssStyle="margin-top:10px;">
					<ta:panel key="已分配权限" fit="true" headerButton="[{'id':'pos_MissionBtn','name':'更改','click':'fnUsePermissionByPos();'}]" >
						<ta:datagrid id="posMission" columnFilter="true"  fit="true" forceFitColumns="true" >
							...
							<ta:datagridItem key="删除" click="fnDelPosMission" align="center" width="50" icon="icon-delete" />
						</ta:datagrid>
					</ta:panel>
				</ta:box>
				<ta:box height="50%" cssStyle="margin-top:10px;">
					<ta:panel key="岗位下的人员" cssStyle="margin-top:5px;" fit="true" headerButton="[{'id':'pos_UserAssignBtn','name':'更改','click':'fnAssignUser();'},{'id':'pos_UserDelBtn','name':'批量删除','click':'fnDeletePositionUser();'}]" >
						<ta:datagrid id="posUser" haveSn="true" columnFilter="true" forceFitColumns="true" selectType="checkbox"  fit="true" >
							...
							<ta:datagridItem key="删除" align="center" width="50" click="fnDeletePositionUserSingle" icon="icon-delete" />
						</ta:datagrid>
					</ta:panel>
				</ta:box>
				<ta:box height="50%" id="sharePosBox" cssStyle="margin-top:10px">
					<ta:panel key="共享岗位" fit="true" headerButton="[{'id':'pos_ShareBtn','name':'更改','click':'fnSharePosition();'}]" >
						<ta:datagrid id="posShare" fit="true" columnFilter="true"  forceFitColumns="true">
							<ta:datagridItem id="orgnamepath" width="300" showDetailed="true" key="所属组织"  />
							<ta:datagridItem key="删除" align="center" width="50" click="fnDeleteSharePosition" icon="icon-delete"  />
						</ta:datagrid>
					</ta:panel>
				</ta:box>
			</ta:box>
	...
	<ta:tab  id="tabUser" layout="border"  layoutCfg="{leftWidth:410}" key="人员权限"  >
		<ta:box fit="true" position="left" cssStyle="padding: 10px;" key="人员维护">
			<ta:fieldset id="queryUser" cols="2">
				<ta:selectTree url="positionUserMgAction!webQueryAsyncOrgTree.do" labelWidth="80"   fontCss="fnFontCss" selectTreeBeforeClick="fnBeforeClick"
				...
				<ta:text id="text" labelWidth="80" columnWidth="0.75" keys="[{name:'username',key:'姓名'},{name:'loginids',key:'账号'}]" placeholder="请输入账号或用户名..."></ta:text>
				<ta:buttonGroup columnWidth="0.25" align="left">
					<ta:button key="查找" onClick="fnQueryUser();"></ta:button>
				</ta:buttonGroup>
			</ta:fieldset>
			<ta:buttonGroup align="left" cssStyle="height:32px;padding-left:0px;margin-top:5px;">
			...
			<ta:panel fit="true" key="人员列表" cssStyle="margin-bottom:5px;">
				<ta:datagrid id="userGrid" fit="true" haveSn="true" forceFitColumns="true"  selectType="checkbox" onSelectChange="fnUserSelectChange">
					...
					<ta:dataGridToolPaging url="positionUserMgAction!queryUsers.do" showExcel="false" submitIds="queryUser" pageSize="50" />
				</ta:datagrid>
			</ta:panel>
		</ta:box>
		<ta:box position="center" id="perMissionBox" cssStyle="padding:0 10px;">
				...
				<ta:box height="50%">
					<ta:panel key="人员权限列表" headerButton="[{'id':'assignPerMission','name':'更改','click':'fnUsePermissionByUser();'}]" fit="true" >
						<ta:datagrid id="perMission" columnFilter="true"  fit="true" forceFitColumns="true" >
							...
							<ta:datagridItem id="effecttime" key="有效期" formatter="fnEffecttime"  />
							<ta:datagridItem id="auditstate" key="通过审核" hiddenColumn="true" collection="AUDITSTATE"  />
							<ta:datagridItem width="50" icon="icon-search" align="center" dataAlign="center" key="岗位" click="fnShowPossition" />
							<%--<ta:datagridItem key="删除个人权限"  align="center" width="100" icon="icon-remove" click="fnDelPerMission" /> --%>
						</ta:datagrid>
					</ta:panel>
				</ta:box>
				<ta:box id="b2" height="50%" cssStyle="margin-top:10px;">
					<ta:panel key="已分配岗位" fit="true" heightDiff="10" headerButton="[{'id':'assignPos','name':'更改','click':'fnAssignPositionsToUser();'}]" >
						<ta:datagrid id="perPosition" fit="true" columnFilter="true" forceFitColumns="true" >
							...
							<ta:datagridItem key="删除" width="50" align="center" click="fnDelPosition" icon="icon-delete" />
						</ta:datagrid>
					</ta:panel>
				</ta:box>
			</ta:box>
...
<script  type="text/javascript">
    $(document).ready(function () {
        ...
        if(result.fieldData.isopen){
            Base.enableTab("tabPos");
            //fnQueryPos();
            disablePosBtn();
        }else{
            Base.setDisabled("tabPos");
        }
        ...
        /* change by 周泓宇 2017-3-16*/
        if(isAudite.fieldData.isAudite){
        ...
        $(".tabs-panels").css("overflow-x","hidden");//修改横向滚动条

		//fnQueryUser();
    });

    function fnPageGuide(currentBuinessId){
        var label = $($("#queryUser").find("#text")[0]).parent().siblings("label");
        var data = [
            {id:$($(".tabs-li")[1]),
    ...
    function fnQueryUser(){
		var treeValue = Base.getValue("orgTree");
    	if(null == treeValue || "" == treeValue){
			Base.setValue("orgTree","1");
		}
        Base.submit("queryUser","positionUserMgAction!queryUsers.do",null,null,null,null/*function(){
    ...
    function setMainPosition(data,e){
        if(data.mainposition == 1){
            ...
            Base.confirm("确认设置\""+data.positionname + "\"为默认使用岗位?",function(yes){
                if(yes){
                    Base.submit("","positionUserMgAction!setMainPosition.do",{"positionid":data.positionid,"per_userid":Base.getValue("per_userid")},null,null,function(){
...
// 	fnFormatterSelect(obj,"#BDC2F3");
    ...
    /**查询岗位*/
    function fnQueryPos(){
    	var posTreeValue = Base.getValue("pos_orgTree");
    	if(null == posTreeValue || "" == posTreeValue){
    		Base.setValue("pos_orgTree","1");
		}
        Base.submit("queryPos","positionUserMgAction!queryPosition.do",null,null,null,null/*function(){
    ...
    function fnUsePermissionByUser(){
        ...
        Base.openWindow("opPermission", $("#per_name").text() + " ->功能使用权限", "positionUserMgAction!toFuncOpPurview.do", {"positionid":positionid,"positionType":2,"userid":userid}, "690", "90%",null,null,true);
    }
    ...
    function fnBatchPermissions(flag){
        ...
        if(o.length == 0){
            ...
            switch (flag) {
                case 1:
                    Base.openWindow("opWin","批量回收使用权限","positionUserMgAction!toRecyclePermissions.do",{"positionids":str,"dto['positionType']":2,"userid":userid,"positionid":positionid},"35%","80%",null,null,true);
                    break;
                case 2:
                    Base.openWindow("opWin","批量授予使用权限","positionUserMgAction!toGrantUsePermissions.do",{"positionids":str,"dto['positionType']":2,"userid":userid,"positionid":positionid},"35%","80%",null,null,true);
                    break;
                default:
                    break;
            }
    ...
    function fnAssignPositionsToUser(){
        ...
        Base.openWindow("win", positionname + "->岗位设置", "positionUserMgAction!toAssignPositionsToUser.do", {"userid" :userid,"positionids":str,"positionid":positionid}, "840", "500",null,null,true);
    }
    /**新增岗位*/
    ...
    function fnSelectChange(rowsData,n){
		...
		if(n ==1 ){
			...
			Base.submit("","positionUserMgAction!queryPosMission.do",{"pos_positionid":Base.getValue("pos_positionid")},null,null,function(d){
				/* if(data.iscopy == 1){
    ...
    function fnGridRowEdit(){
        ...
        if(o != null){
            var param = {};
            param["positionid"] = o[0].positionid;
    ...
    function fnPosBatchPermissions(flag){
        ...
        if(bool){
            ...
            switch (flag) {
                case 1:
                    Base.openWindow("opWin","批量回收使用权限","positionUserMgAction!toRecyclePermissions.do",{"positionids":str,"dto['positionType']":1,"positionid":positionid},"35%","80%",null,null,true);
                    break;
                case 2:
                    Base.openWindow("opWin","批量授予使用权限","positionUserMgAction!toGrantUsePermissions.do",{"positionids":str,"dto['positionType']":1,"positionid":positionid},"35%","80%",null,null,true);
                    break;
                default:
                    break;
            }
    ...
    function fnUsePermissionByPos(){
        ...
        var positionid = Base.getValue("pos_positionid");
        Base.openWindow("opPermission", $("#pos_name").text() + " ->功能使用权限", "positionUserMgAction!toFuncOpPurview.do", {"positionid":positionid,"positionType":1}, "683", "80%",null,null,true);
    }
    /**查看岗位权限*/
    function fnQueryPosMission(data,e){
        Base.openWindow("posMissionwin", data.positionname + " ->功能使用权限", "positionUserMgAction!toPosMissionWindow.do", {"positionid":data.positionid,"positionType":data.positiontype}, "35%", "80%",null,null,true);
    }
    /**删除岗位权限*/
    ...
    function fnAssignUser(){
		Base.openWindow("assignUser",$("#pos_name").text() + "->人员选择","positionUserMgAction!toAssignUser.do",{"dto['positionid']":Base.getValue("pos_positionid")},"100%","100%",null,null,true);
    }
    /**移除岗位下的人员*/
