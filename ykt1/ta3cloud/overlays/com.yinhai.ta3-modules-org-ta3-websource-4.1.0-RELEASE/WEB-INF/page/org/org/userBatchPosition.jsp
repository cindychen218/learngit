...
<ta:panel id="opPanel"  fit="true"  withButtonBar="true" hasBorder="false" cols="2">
	...
	<ta:box span="2" cssStyle="padding:10px;">
		...
		<ta:box id ="menuContent" height="250px"  cssStyle="border-radius: 4px;box-shadow: 0 0 10px rgba(0,0,0,.5);background:white;display:none;width:274px;top:28px;left:100px;border:1px solid #99BBE8;overflow:auto;position:absolute;z-index:1000;">
			<ta:panel fit="true" withButtonBar="true" hasBorder="false" bodyStyle="overflow:auto;">
				...
				<ta:panelButtonBar align="center" >
					...
					<ta:button key="关闭" id="menuBtn1" onClick="hideMenu()"></ta:button>
				</ta:panelButtonBar>
			</ta:panel>
		</ta:box>
	</ta:box>
	<ta:panelButtonBar align="right">
		<ta:button key="保存[S]" icon="icon-addTo" hotKey="S" onClick="fnChangePosition()" />
		<ta:button key="关闭[X]" hotKey="X" icon="icon-close2" onClick="parent.Base.closeWindow('win')"/>
	</ta:panelButtonBar>
</ta:panel>
</body>
</html>
