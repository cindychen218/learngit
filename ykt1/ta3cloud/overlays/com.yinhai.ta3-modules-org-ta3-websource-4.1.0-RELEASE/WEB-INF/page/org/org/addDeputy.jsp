    ...
    <ta:box fit="true" id="userGridBox" cssStyle="padding:10px;" columnWidth="0.7">
        <ta:box>
            <ta:fieldset cols="12" id="userQuery">
                ...
                <ta:text id="operationFlag" display="false" value="addDeputy"/>
...
// 				var target=Base.getObj("searchbox");
    ...
    function addDeputy(){
        ...
        Base.confirm("确定要新增该批人员为副职吗？", function(yes){
            if(yes){
                Base.submit("userGd", "positionMgAction!addDeputy.do", null, null, false, function(data){
                    if(data.success) {
                        Base.msgTopTip("<div class='msgTopTip'>人员副职信息新增成功!</div>");
                        fnClose();
                    }
                });
            }
