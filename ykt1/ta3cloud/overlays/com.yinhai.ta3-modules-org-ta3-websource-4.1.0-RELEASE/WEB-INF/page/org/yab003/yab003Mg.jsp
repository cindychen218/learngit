...
<ta:box id="container" layout="border" layoutCfg="{leftWidth:375}">
	...
	<ta:box position="center" cols="3" key="数据区分配" cssStyle="padding:10px;">
		...
		<ta:panel id="centerLeft" key="未分配数据区" fit="true" columnWidth="0.44">
		...
		<ta:box  columnWidth="0.12" cssStyle="margin-left:10px;">
		...
		<ta:panel id="centerRight" key="已分配数据区" fit="true" cssStyle="margin-left:10px;"  columnWidth="0.44">
