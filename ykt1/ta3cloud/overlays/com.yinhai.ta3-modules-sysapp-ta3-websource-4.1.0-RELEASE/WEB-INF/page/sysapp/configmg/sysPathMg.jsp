...
<ta:panel fit="true" span="3" hasBorder="true" withToolBar="true" key="系统路径">
	<ta:panelToolBar>
		<ta:button key="新增" asToolBarItem="true" icon="icon-add2" onClick="fnAdd()"></ta:button>
	</ta:panelToolBar>
...
<script type="text/javascript">
    ...
    function fnEdit(data,e){
        Base.openWindow("syspath","系统路径配置","configSysPathAction!toSaveUpdateSyspath.do",{"saveUpdate":"update","id":data.id},400,310,null,function(){
    ...
    function fnAdd(){
        Base.openWindow("syspath","系统路径配置","configSysPathAction!toSaveUpdateSyspath.do",{"saveUpdate":"save"},400,310,null,function(){
            Base.submit("","configSysPathAction!querySyspath.do");
        },true);
    }
</script>
