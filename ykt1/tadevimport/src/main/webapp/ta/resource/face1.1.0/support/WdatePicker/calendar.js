...
function My97DP() {
    ...
    $d.innerHTML = "<div id=dpTitle><div class=\"navImg NavImgll\"><a class='WdateIcon icon-arrow2_first'></a></div><div class=\"navImg NavImgl\"><a class='WdateIcon icon-arrow2_left'></a></div><div style=\"float:left\"><div class=\"menuSel MMenu\"></div><input class=yminput></div><div style=\"float:left\"><div class=\"menuSel YMenu\"></div><input class=yminput></div><div class=\"navImg NavImgrr\"><a class='WdateIcon icon-arrow2_last'></a></div><div class=\"navImg NavImgr\"><a class='WdateIcon icon-arrow2_right'></a></div><div style=\"float:right\"></div></div><div style=\"position:absolute;overflow:hidden\"></div><div></div><div id=dpTime><div class=\"menuSel hhMenu\"></div><div class=\"menuSel mmMenu\"></div><div class=\"menuSel ssMenu\"></div><table cellspacing=0 cellpadding=0 border=0><tr><td rowspan=2><span id=dpTimeStr></span>&nbsp;<input class=tB maxlength=2><input value=\":\" class=tm readonly><input class=tE maxlength=2><input value=\":\" class=tm readonly><input class=tE maxlength=2></td><td class='Wdate-bg-blue'><button id=dpTimeUp></button></td></tr><tr><td  class='Wdate-bg-blue'><button id=dpTimeDown></button></td></tr></table></div><div id=dpQS class='WdateIcon icon-timequick'></div><div id=dpControl><input class=dpButton id=dpClearInput type=button><input class=dpButton id=dpTodayInput type=button><input class=dpButton id=dpOkInput type=button></div>";
...
My97DP.prototype = {
    ...
    _fillQS: function(C, A) {
        ...
        if (!C) _.a("<div class='WdateIcon icon-close' style=\"float:right;cursor:pointer\" onclick=\"hide($d.qsDivSel);\"></div>");
        _.a("</td></tr>");
...
function _focus($) {
    ...
    showB(_);
    if ("Hms".indexOf(A) >= 0) {
        var dpQS =document.getElementById("dpQS").style.display;
        if(dpQS === 'none' && this.className === 'tE'){
            _.style.marginTop = this.offsetTop - _.offsetHeight + 20 + 'px'; //add by Selina time="true"分钟选择框溢出
        }else {
            _.style.marginTop = this.offsetTop - _.offsetHeight + 'px';
        }
    }
}
