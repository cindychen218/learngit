...
<%@attribute description='设置默认分页大小,可以传入一个值或者数组,每页最大设置条数为99999,超过99999将自动转换成99999' name='pageSize' type='java.lang.String' %>
...
<% if( null != pageSize)  { %>
o.pagingOptions.pageSize =eval(${pageSize});
<% }%>
<% if( null != showCount)  { %>
...
o.pagingOptions.exportFileName = "${exportFileName}";
<% }%>
